...
python $script_dir/docker_challengeScheduled.py --timeQuota 14400000 --threads 4 --canCancel -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications score 8720143 >> $script_dir/log/score.log 2>&1
