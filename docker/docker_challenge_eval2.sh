...
python $script_dir/docker_challengeScheduled.py --threads 4 --canCancel -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications score 8720145 >> $script_dir/log/score.log 2>&1
